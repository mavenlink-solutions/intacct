module Intacct
  module Actions
    class Create < Base
      LEGACY_API_CLASSES = ["Intacct::Models::Expense", "Intacct::Models::SalesDocument", "Intacct::Models::Sotransaction"].freeze

      def request(_options)
        if LEGACY_API_CLASSES.include?(klass.class.to_s)
